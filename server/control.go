...
func NewControl(ctlConn conn.Conn, authMsg *msg.Auth) {
	...
	if authMsg.Version != version.Proto {
		failAuth(fmt.Errorf("Incompatible versions. Server %s, client %s. Download a new version at https://github.com/darknio88/pgrok", version.MajorMinor(), authMsg.Version))
		return
	}
